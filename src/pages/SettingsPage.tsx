        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6">
            <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
              ...
              <h2 className="text-lg sm:text-xl font-bold text-slate-800">Informasi Profil</h2>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6">
            <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
              ...
              <h2 className="text-lg sm:text-xl font-bold text-slate-800">Ganti Password</h2>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6">
            <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
              ...
              <h2 className="text-lg sm:text-xl font-bold text-slate-800">Preferensi</h2>
            </div>
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="flex items-center justify-between p-3 sm:p-4 bg-slate-50 rounded-lg">
                <div className="flex items-center gap-2 sm:gap-3">
                  {darkMode ? <Moon className="w-4 h-4 sm:w-5 sm:h-5 text-slate-600" /> : <Sun className="w-4 h-4 sm:w-5 sm:h-5 text-slate-600" />}
                  <div>
                    <p className="font-semibold text-sm sm:text-base text-slate-900">Mode {darkMode ? 'Gelap' : 'Terang'}</p>
                    <p className="text-xs sm:text-sm text-slate-500">Ubah tampilan aplikasi</p>
                  </div>
                </div>
                <button
              ...
              <div className="flex items-center justify-between p-3 sm:p-4 bg-slate-50 rounded-lg">
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-sm sm:text-base text-slate-900">Notifikasi</p>
                    <p className="text-xs sm:text-sm text-slate-500">Terima notifikasi penting</p>
                  </div>
                </div>
                <button
          ...
          {/* Logout */}
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6">
            <button className="flex items-center justify-center gap-2 px-6 py-2.5 sm:py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 w-full font-semibold shadow-sm transition-colors text-sm sm:text-base">
